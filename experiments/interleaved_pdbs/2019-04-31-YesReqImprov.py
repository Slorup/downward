...
from common_setup import IssueConfig, IssueExperiment, DEFAULT_OPTIMAL_SUITE, SANTI_OPTIMAL_SUITE, is_test_run, get_experiment_name
...
#    'search_time',
    ...
    def make_cumulative_plots():
        make_cumulative_plot("total_time", "gamer", ["D", "ID", "RT", "IO", "IOT"])
        make_cumulative_plot("total_time", "sart", ["RT", "IOT", "LmCut"])
