...
static shared_ptr<PDBFactory>_parse(options::OptionParser &parser) {
    ...
    if(sizeof(void*) == 8){
      ...
      cout<<"32 bits, setting precompuation and termination_nodes limit for symbolic PDB generation accordingly, assuming pre-IPC-18 memory limit of 4GBs total and 2GBs for PDB building."<<endl;
