...
def parse_args():
    ...
    argparser.add_argument(
        "--remove_irrelevant_predicates_actions", default=True, type=bool, dest="remove_irrelevant_predicates_actions",
        help="Remove irrelevant actions and predicates before grounding."
    )
